...
if(strlen($_SESSION['uid']==0)) {
  ...
  if(isset($_POST['submit'])) {
    ...
    $query=mysqli_query($con,"select empId from employees where empId='$Id' and empPassword='$cpassword'");
    $row=mysqli_fetch_array($query);
    if($row>0) {
      $ret=mysqli_query($con,"update employees set empPassword='$newpassword' where empId='$Id'");
